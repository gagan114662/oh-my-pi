...
/// Readline keymap selected by `bind -m`.
#[derive(Clone, Copy, Debug, Eq, Hash, PartialEq)]
pub enum KeyMap {
	/// Standard Emacs keymap.
	EmacsStandard,
	/// Emacs Meta-prefix keymap.
	EmacsMeta,
	/// Emacs Control-X-prefix keymap.
	EmacsCtlx,
...
pub trait KeyBindings: Send {
	/// Selects the keymap affected by subsequent operations.
	fn select_keymap(&mut self, keymap: KeyMap) -> Result<(), std::io::Error>;
