...
//! Port of the historical `@oh-my-pi/hashline` engine package plus the
//! coding-agent runner (`edit/hashline/*`).

/// Hashline edit application.
pub mod apply;
/// Syntactic-block resolution.
pub mod block;
/// Clipboard operation resolution.
pub mod clipboard;
/// Hashline wire-format constants.
pub mod format;
/// Section splitting and parsed input.
pub mod input;
/// Model-facing hashline diagnostics.
pub mod messages;
/// Snapshot mismatch handling.
pub mod mismatch;
/// Hashline token execution and parsing.
pub mod parser;
/// Hashline patch staging.
pub mod patcher;
/// Read-prefix normalization.
pub mod prefixes;
/// Hashline streaming previews.
pub mod preview;
/// Stale-snapshot recovery.
pub mod recovery;
/// Cached syntax-analysis helpers.
pub mod syntax;
/// Hashline tokenizer.
pub mod tokenizer;
/// Shared hashline data types.
pub mod types;
...
/// Hashline mode engine.
pub struct HashlineEngine {
	/// Require anchors to have appeared in the recorded read snapshot.
