...
impl ArgStream {
	...
	/// Append an argument-stream fragment.
	...
	/// Return whether the stream has been marked complete.
	pub const fn is_finished(&self) -> bool {
		self.finished
	}

	/// Return the buffered wire text.
	pub fn buffer(&self) -> &str {
		&self.buf
	}

	/// Return whether the buffer is a non-JSON custom payload.
