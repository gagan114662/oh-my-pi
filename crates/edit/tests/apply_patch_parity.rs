//! TypeScript parity coverage for apply-patch mode.
...
fn partial_json_edit_entries_parity() {
	let complete = omp_edit::stream_json::snapshot_from_text(
	...
	let trailing_open = omp_edit::stream_json::snapshot_from_text(
		r#"{"path":"a","edits":[{"op":"delete"},{"op":"delete""#,
		false,
		false,
	);
	...
	let newly_opened = omp_edit::stream_json::snapshot_from_text(
	...
	let empty = omp_edit::stream_json::snapshot_from_text(r#"{"edits":["#, false, false);
